/**
 * Migration: Apaga todos os dados operacionais.
 * Preserva: users, user_profiles, system_screens, profile_permissions,
 *           parameters, packaging_types, volume_discounts, system_rules.
 *
 * TRUNCATE CASCADE remove todas as dependências automaticamente.
 * RESTART IDENTITY zera os auto-incrementos.
 */
...
exports.up = async function (knex) {
  ...
  if (isPg) {
    // Pega todas as tabelas do schema público, exclui as preservadas
    ...
    // SQLite: desativa FK, apaga em ordem segura, reativa
    const ordered = [
